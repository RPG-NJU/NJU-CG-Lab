...
void AboutAuthorDialog::on_buttonAuthorGithub_clicked()
{
	...
	ShellExecute(nullptr, L"open", L"https://github.com/HELLORPG", nullptr, nullptr, SW_SHOWMAXIMIZED);
...
{
	ShellExecute(nullptr, L"open", L"mailto:officialrpg2017@gmail.com", nullptr, nullptr, SW_SHOWNORMAL);
	return;
}
